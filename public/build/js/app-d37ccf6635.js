 ...
 * @return                false
 */
aptList.methods.setCurrentApartmentOrder = function (vm, callback) {
...
aptList.methods.storeApartmentOrder = function (vm) {
    vm.$http.put(vm.api.updateOrder, vm.order.update, function () {}).error(function (data, status) {
...
aptList.methods.dispatchAlertMessage = function (value, status, timeout) {
    this.$dispatch('add-alert-message', { value: value, status: status, timeout: timeout });
...
},{"dragula":2}],27:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("/* line 4, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_box-sizing.scss */\nhtml {\n  box-sizing: border-box; }\n\n/* line 9, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_box-sizing.scss */\n*, *::after, *::before {\n  box-sizing: inherit; }\n\n/* line 4, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  content: '';\n  display: table;\n  clear: both;\n  content: '';\n  display: table;\n  clear: both;\n  max-width: 1200px;\n  margin-left: auto;\n  margin-right: auto;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  width: 100%; }\n  /* line 13, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list > li {\n    content: '';\n    display: table;\n    clear: both;\n    position: relative;\n    width: 100%;\n    padding: 10px 15px;\n    border: 1px solid #ccc; }\n  /* line 21, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list .sort-handle {\n    text-indent: -9999px; }\n    /* line 24, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n    .apartment-list .sort-handle:before {\n      text-indent: 0; }\n\n/* line 30, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-title {\n  margin-top: 0;\n  margin-bottom: 15px;\n  float: left; }\n  @media screen and (min-width: 769px) {\n    /* line 30, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n    .apartment-list-title {\n      float: left;\n      display: block;\n      margin-right: 2.35765%;\n      width: 48.82117%; }\n      /* line 89, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_span-columns.scss */\n      .apartment-list-title:last-child {\n        margin-right: 0; } }\n\n/* line 45, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-menu {\n  content: '';\n  display: table;\n  clear: both;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  float: right;\n  clear: none; }\n  /* line 51, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list-menu > li {\n    float: left; }\n\n/* line 60, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-details {\n  margin: 0;\n  padding: 0;\n  list-style: none; }\n")
'use strict';

module.exports = require('./list.js');
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<ul id=\"apartment_list\" class=\"apartment-list\">\n    <li v-for=\"apartment in apartments\">\n        <h4 class=\"apartment-list-title\" @click=\"toggleShowDetails($index)\">\n            {{ apartment.name }}\n        </h4>\n        <ul class=\"apartment-list-menu\">\n            <li>\n                <a href=\"/apartments/{{ apartment.id }}/edit\" class=\"apartment-edit-btn icon-pencil\" title=\"Edit {{ apartment.name }}\">\n                    Edit\n                </a>\n            </li>\n            <li>\n                <form method=\"POST\" action=\"/apartments/{{ apartment.id }}\" accept-charset=\"UTF-8\" @submit.prevent=\"deleteApartment($index)\" class=\"apartment-list-delete-form\">\n                    <input name=\"_method\" type=\"hidden\" value=\"DELETE\">\n                    <input name=\"_token\" type=\"hidden\" value=\"{{ token }}\">\n                    <button type=\"submit\" class=\"apartment-delete-btn icon-bin2\" title=\"Edit {{ apartment.name }}\">\n                        Delete\n                    </button>\n                </form>\n            </li>\n            <li>\n                <span class=\"js-dragula-handle icon-menu2 sort-handle\"></span>\n                <input type=\"hidden\" class=\"js-dragula-order\" value=\"{{ apartment.order }}\">\n                <input type=\"hidden\" class=\"js-dragula-id\" value=\"{{ apartment.id }}\">\n            </li>\n        </ul>\n        <ul class=\"apartment-details\" v-show=\"apartment.showDetails\">\n            <li>\n                <strong>Location</strong>\n                <address>\n                    {{ apartment.addressLine1 }}<br>\n                    {{ apartment.addressLine2 }}<br>\n                    {{ apartment.city }}, {{ apartment.state }} {{ apartment.zip }}\n                </address>\n            </li>\n            <li>\n                <strong>Notes:</strong><br>\n                {{{ apartment.notes }}}\n            </li>\n            <li>\n                <strong>Price:</strong> ${{ apartment.price }}\n            </li>\n            <li>\n                <strong>Parking Price:</strong> ${{ apartment.parkingPrice }}\n            </li>\n            <li>\n                <strong>Deposit:</strong> ${{ apartment.deposit }}\n            </li>\n        </ul>\n    </li>\n</ul>\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["/* line 4, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_box-sizing.scss */\nhtml {\n  box-sizing: border-box; }\n\n/* line 9, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_box-sizing.scss */\n*, *::after, *::before {\n  box-sizing: inherit; }\n\n/* line 4, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list {\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  content: '';\n  display: table;\n  clear: both;\n  content: '';\n  display: table;\n  clear: both;\n  max-width: 1200px;\n  margin-left: auto;\n  margin-right: auto;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  width: 100%; }\n  /* line 13, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list > li {\n    content: '';\n    display: table;\n    clear: both;\n    position: relative;\n    width: 100%;\n    padding: 10px 15px;\n    border: 1px solid #ccc; }\n  /* line 21, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list .sort-handle {\n    text-indent: -9999px; }\n    /* line 24, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n    .apartment-list .sort-handle:before {\n      text-indent: 0; }\n\n/* line 30, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-title {\n  margin-top: 0;\n  margin-bottom: 15px;\n  float: left; }\n  @media screen and (min-width: 769px) {\n    /* line 30, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n    .apartment-list-title {\n      float: left;\n      display: block;\n      margin-right: 2.35765%;\n      width: 48.82117%; }\n      /* line 89, /Users/dholloran/Code/apartment-list/node_modules/bourbon-neat/app/assets/stylesheets/grid/_span-columns.scss */\n      .apartment-list-title:last-child {\n        margin-right: 0; } }\n\n/* line 45, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-menu {\n  content: '';\n  display: table;\n  clear: both;\n  margin: 0;\n  padding: 0;\n  list-style: none;\n  float: right;\n  clear: none; }\n  /* line 51, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n  .apartment-list-menu > li {\n    float: left; }\n\n/* line 60, /Users/dholloran/Code/apartment-list/resources/assets/js/components/apartments/list/list.scss */\n.apartment-list-details {\n  margin: 0;\n  padding: 0;\n  list-style: none; }\n"] = false
    document.head.removeChild(__vueify_style__)
  })
